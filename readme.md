...
- Distance d<sub>i</sub>: Distance from the origin of i-1 to the intsection of the z<sub>i-1</sub> axis  with the x<sub>i</sub> axis along the z<sub>i-1</sub> axis.
- Armlength a<sub>i</sub>: Distance from the intersection of z<sub>i-1</sub> axis with the x<sub>i</sub> to the origin of the ith coordinate system along the x<sub>i</sub> axis.
- Armtorsion α<sub>i</sub>: Angle between the z<sub>i-1</sub> and the z<sub>i</sub> axis

Example from Wikipedia:
![DH Example](Pictures/DH_Parameters_Example.png)
